...
public class Main {
    ...
    public static void main(String[] args) {
		...
		// Tests Environnement avec FoodGenerator
     ...
     // quelques tests pour l'étape 10
        ...
        env.update(Time.fromSeconds(1.));
     // toutes les quantités deviennent négligeables et doivent être supprimées
     ...
     //Test de la méthode spreadPheromone() quand celle ci est déclarée en public 
     //au lieu de private comme exigé par la consigne
     
//	 System.out.println();
//	 System.out.println("test spredPheromone()");
