...
/**
 * Classe finale utilitaire fournissant diverse méthodes statiques
 */
public final class Utils {
    ...
    /**
	 * Sélectionne une valeur du tableau {@code values} conformément aux
	 * probabilités spécifiées par {@code probs}
	 *
	 * @param values : un tableau de double des valeurs à considérer
	 * @param probs  : un tableau de double représentant la probabilité associée à
	 *               chaque valeur du tableau {@code values}
    ...
    /**
	 * Lance une exception de type {@code IllegalArgumentException} si l'objet
	 * {@code toTest} est {@code null}.
	 *
	 * @param message Le message détaillé de l'erreur
	 * @param toTest  L'objet qui, si vaut {@code null}, provoque l'exception
    ...
    /**
	 * Retourne l'objet {@link Positionable} de {@code collection} qui est le plus
	 * proche en terme de distance torique de l'objet {@link Positionable}
	 * {@code entity}.
	 *
	 * @param entity     L'entité dont on souhaite trouver l'objet le plus proche
	 * @param collection La collection que l'on considère pour trouver l'objet le
	 *                   plus proche de {@code entity}
	 * @param <T>        Le type de {@code entity}
	 * @param <S>        Le type des éléments de {@code collection}
	 * 
	 * @throws IllegalArgumentExeception : exception lancée si 1) {@code entity} ou
	 *                                   2) {@code collection} sont {@code null}
	 * 
	 * @return L'objet le plus proche de {@code entity}
	 */
    public static <T extends Positionable, S extends Positionable>
			S closestFromPoint(T entity, Collection<S> collection) throws IllegalArgumentException
    {
		...
		S s = Collections.min(collection, (a, b) -> {
